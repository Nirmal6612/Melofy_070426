...
const CloudinaryUpload = ({setUrl}) => {
  ...
  return (
    <button className="bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-white p-2 rounded-full hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors duration-200" onClick={uploadImageWidget}>
      Select Track
    </button>
  );
};
